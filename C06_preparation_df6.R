...
summary(df_6_camp_event_clean_final$CLICKED)
## compute aggregate
...
summary(df_6_camp_event_clean_final$FAILED)
## compute aggregate
...
# - NUM_OPENs
summary(df_6_camp_event_clean_final$NUM_OPENs)
ggplot(data = df_6_camp_event_clean_final, aes(x = "", y = NUM_OPENs)) + 
  geom_boxplot() 

# - NUM_CLICKs
summary(df_6_camp_event_clean_final$NUM_CLICKs)
ggplot(data = df_6_camp_event_clean_final, aes(x = "", y = NUM_CLICKs)) + 
  geom_boxplot() 
